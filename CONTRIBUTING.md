...
please use the [issue tracker](https://github.com/apirogov/test-python-cookiecutter-app/issues).
...
```
git clone git@github.com:apirogov/test-python-cookiecutter-app.git
cd test-python-cookiecutter-app
